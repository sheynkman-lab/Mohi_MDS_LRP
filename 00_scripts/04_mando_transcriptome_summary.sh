...
--sq_out 02_sqanti/mando/WT_mando_classification.txt \
--ensg_to_gene 01_reference_tables/ensg_gene.tsv \
--enst_to_isoname 01_reference_tables/enst_isoname.tsv \
--odir 04_transcriptome_summary/mando/WT

# Q157R
python 00_scripts/04_transcriptome_summary_gene_table_only.py \
--sq_out 02_sqanti/mando/Q157R_mando_classification.txt \
--ensg_to_gene 01_reference_tables/ensg_gene.tsv \
--enst_to_isoname 01_reference_tables/enst_isoname.tsv \
--odir 04_transcriptome_summary/mando/Q157R/
