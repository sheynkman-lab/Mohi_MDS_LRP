...
python /project/sheynkman/programs/SQANTI3-5.2/sqanti3_qc.py \
    -o WT_isoquant \
    -d 02_sqanti/isoquant \
    --skipORF \
    --fl_count 01_isoquant/WT_fl_count_for_sqanti3.csv \
    01_isoquant/WT/WT.transcript_models.gtf \
...
python /project/sheynkman/programs/SQANTI3-5.2/sqanti3_qc.py \
    ...
    -d 02_sqanti/isoquant \
    --skipORF \
    --fl_count 01_isoquant/Q157R_fl_count_for_sqanti3.csv \
    01_isoquant/Q157R/Q157R.transcript_models.gtf \
    /project/sheynkman/external_data/GENCODE_M35/gencode.vM35.basic.annotation.gtf \
    /project/sheynkman/external_data/GENCODE_M35/GRCm39.primary_assembly.genome.fa